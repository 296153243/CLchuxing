    ...
    if (self.isRefund) {
        ...
        if (self.number.length > 0) {
            ...
            if (self.showNumber) {
                ...
                NSAttributedString *carTempAttributeString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"\n余%@",self.number] attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName:self.bottomColor}];
                ...
                NSMutableAttributedString *carAttributeString = [[NSMutableAttributedString alloc] initWithString:[dateFormatter stringFromDate:_date]];
                NSAttributedString *carTempAttributeString = [[NSAttributedString alloc] initWithString:@"\n可退" attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName:self.bottomColor}];
                [carAttributeString appendAttributedString:carTempAttributeString];
            ...
            NSMutableAttributedString *carAttributeString = [[NSMutableAttributedString alloc] initWithString:[dateFormatter stringFromDate:_date]];
            NSAttributedString *carTempAttributeString = [[NSAttributedString alloc] initWithString:@"\n" attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName:self.bottomColor}];
            [carAttributeString appendAttributedString:carTempAttributeString];
        ...
        if (self.ticketPrice.length > 0) {
            ...
            if (self.showNumber) {
                ...
                NSMutableAttributedString *carAttributeString = [[NSMutableAttributedString alloc] initWithString:[dateFormatter stringFromDate:_date]];
                NSAttributedString *carTempAttributeString = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"\n%@元",self.ticketPrice] attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName:self.bottomColor}];
                [carAttributeString appendAttributedString:carTempAttributeString];
