...
-(void)prepareAlertToDisplay
{
    ...
    [_showView.cancelBtn setCornerRadius:4.0f AndBorder:1.0f borderColor:HEXCOLOR(@"777777")];
    ...
    _showView.cancelBottomConstraint.constant = SCREEN_BOTTOM_MARGIN + 10;
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch ([number integerValue]) {
        ...
        case SSDKPlatformSubTypeWechatSession:{
            [cell.iconImageView setImage:[UIImage imageNamed:@"share_wechat"]];
            [cell.nameLabel setText:@"微信"];
        }
            break;
            
        case SSDKPlatformSubTypeWechatTimeline:{
            [cell.iconImageView setImage:[UIImage imageNamed:@"share_wechatTimeline"]];
            [cell.nameLabel setText:@"朋友圈"];
        }
            break;
            
        case SSDKPlatformSubTypeQQFriend:{
            [cell.iconImageView setImage:[UIImage imageNamed:@"share_qq"]];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return CGSizeMake(SCREEN_SIZE.width/4, 100);
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([number integerValue] == SSDKPlatformTypeSinaWeibo) {
        ...
        [shareParams SSDKSetupShareParamsByText:[self.shareModel.content stringByAppendingString:self.shareModel.pictureUrl]
                                         images:self.shareModel.pictureLinking
                                            url:[NSURL URLWithString:self.shareModel.pictureUrl]
